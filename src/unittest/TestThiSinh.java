...
public class TestThiSinh {
	...
	@Test
	void testGetNguyenVongMuti() {
		NguyenVong expected = new NguyenVong("MN4", "CNTT", "CN4", "D", 0f);

		NguyenVong actual = this.thiSinh.getNguyenVong("MN4");

		assertEquals(expected, actual);
	}
	
	@Test
	void testExceptionNguyenVongMuti() throws Exception{
		try {
			this.thiSinh.getNguyenVong("VN");
	...
	@Test
	void testExceptionNguyenVong() throws Exception{
		try {
			this.thiSinh.getNguyenVong("VN", "BN");
			fail("Not throw an exception");
		} catch (Exception e) {
			// TODO: handle exception
			assertTrue(e instanceof ElementNotExistException);
	...
	void testGetNguyenVong() {
		...
		NguyenVong actual = this.thiSinh.getNguyenVong("MN4", "CN4");
	...
	void testAddNguyenVongChoThiSinh() {
		...
		assertEquals(expected, thiSinh.getNguyenVong("MN5", "KT4"));
	}
	...
	void testAddListNguyenVongChoThiSinh() {
		...
		NguyenVong actual = thiSinh.getNguyenVong("MN1", "KT1");

		assertEquals(nguyenVong1, actual);
	}
